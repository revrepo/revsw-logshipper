...
var RevportalDB = module.exports = {
  ...
  connect: function( force ) {
    ...
    return mongo.MongoClient.connectAsync( config.service.revportal_db.connection )
      .then( function( db ) {
  ...
  loadShippingJobsList: function() {
    ...
    return ( db_ ? promise.resolve( true ) : this.connect() )
      .then( function() {
        var coll = db_.collection( job_coll_name_ );
        return coll.find({
  ...
  loadDomainNames: function( jobs ) {
    ...
    return ( db_ ? promise.resolve( true ) : this.connect() )
      .then( function() {
        var coll = db_.collection( domain_coll_name_ );
