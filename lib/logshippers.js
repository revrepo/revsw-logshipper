  ...
  return Promise.resolve(job) 
    .then(function(job) {
      return new Promise(function(resolve, reject) {
        ...
        var fileZipName = job._id + '.' + escapedDomainName + '.log.gz';

        var fileStream = fs.createWriteStream( /*target file name*/ stuff.toUploadsPath(fileZipName));
        
        job.shared.file_for_upload = fileZipName;
