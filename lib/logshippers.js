    ...
    .catch(function (err) {
      ...
      if (notifyEmail !== '') {
        mail.sendMail({
          from: 'eng@revsw.com',
          to: notifyEmail,
          subject: process.env.NODE_ENV + ':' + os.hostname() + ' failed to save logs for upload for job',
    ...
    .catch(function (err) {
      ...
      if (notifyEmail !== '') {
        mail.sendMail({
          from: 'eng@revsw.com',
          to: notifyEmail,
          subject: process.env.NODE_ENV + ':' + os.hostname() + ' failed to fire logs for job (ftp)',
          text: err.stack + '\n Job: ' + JSON.stringify(job)
        }, function (er, data) {
          if (er) {
            console.error(er);
    ...
    .catch(function (err) {
      ...
      if (notifyEmail !== '') {
        mail.sendMail({
          from: 'eng@revsw.com',
          to: notifyEmail,
          subject: process.env.NODE_ENV + ':' + os.hostname() + ' failed to fire logs for job (sftp)',
          text: err.stack + '\n Job: ' + JSON.stringify(job)
        }, function (er, data) {
          if (er) {
            console.error(er);
    ...
    .catch(function (err) {
      ...
      if (notifyEmail !== '') {
        mail.sendMail({
          from: 'eng@revsw.com',
          to: notifyEmail,
          subject: process.env.NODE_ENV + ':' + os.hostname() + ' failed to fire logs for job (s3)',
          text: err.stack + '\n Job: ' + JSON.stringify(job)
        }, function (er, data) {
          if (er) {
            console.error(er);
    ...
    .catch(function (err) {
      ...
      if (notifyEmail !== '') {
        mail.sendMail({
          from: 'eng@revsw.com',
          to: notifyEmail,
          subject: process.env.NODE_ENV + ':' + os.hostname() + ' failed to fire logs for job (elastic)',
          text: err.stack + '\n Job: ' + JSON.stringify(job)
        }, function (er, data) {
          if (er) {
            console.error(er);
